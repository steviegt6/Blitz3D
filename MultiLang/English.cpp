...
static constexpr const char* elseif_without_if = "#elseif_ without matching #if_ at line {0}";
static constexpr const char* else_without_if_macro = "#else_ without matching #if_ at line {0}";
