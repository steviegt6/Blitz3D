...
static constexpr MultiLang::string string_parameter_positive = "{0}: parameter must be positive";
static constexpr MultiLang::string string_parameter_greater = "{0}: parameter must be greater than 0";
...
static constexpr MultiLang::string integer_divide_zero = "Integer divide by zero.";
...
static constexpr MultiLang::string illegal_instruction = "Illegal instruction.\nProcess tried to execute an invalid CPU instruction.";
static constexpr MultiLang::string stack_overflow = "Stack overflow.\nMake sure there is no recursion without a base case.";
static constexpr MultiLang::string integer_overflow = "Integer overflow!\nMake sure the integer doesnt exceed a value of 2147483647.";
static constexpr MultiLang::string float_overflow = "Float overflow!\nMake sure the float doesn't exceed a value of 3.40282347e+38F.";
static constexpr MultiLang::string float_divide_zero = "Float divide by zero.";
static constexpr MultiLang::string unknown_runtime_exception = "Unknown runtime exception.";
