...
static constexpr const char* invalid_macro_name = "无效宏名称：{0}（行数：{1}）";
static constexpr const char* redefinition_of_macro = "重复宏名称：{0}（行数：{1}）";
static constexpr const char* error_evaluating_condition = "错误宏运算语句：{0}（行数：{1}）";
static constexpr const char* elseif_without_if = "#elseif_缺少#if_（行数：{0}）";
static constexpr const char* else_without_if_macro = "#else_缺少#if_（行数：{0}）";
static constexpr const char* error_macro = "\"{0}\"（行数：{1}）";
static constexpr const char* macro_exceeded = "宏深度达到限制（行数：{0}）";
