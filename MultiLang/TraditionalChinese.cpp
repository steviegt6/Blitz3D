...
static constexpr const char* invalid_macro_name = "無效宏名稱：{0}（行數：{1}）";
static constexpr const char* redefinition_of_macro = "重複宏名稱：{0}（行數：{1}）";
static constexpr const char* error_evaluating_condition = "錯誤宏運算語句：{0}（行數：{1}）";
static constexpr const char* elseif_without_if = "#elseif_缺少#if_（行數：{0}）";
static constexpr const char* else_without_if_macro = "#else_缺少#if_（行數：{0}）";
static constexpr const char* error_macro = "\"{0}\"（行數：{1}）";
static constexpr const char* macro_exceeded = "宏深度達到限制（行數：{0}）";
